...
Namespace dxSample
    ...
    Public Module FloatComparer
        ...
        ''' </returns>
        <SuppressMessage("ReSharper", "CompareOfFloatsByEqualityOperator", Justification := "It is correct here.GüHa"), SuppressMessage("Reliability", "S1244:Floating point numbers should not be tested for equality", Justification := "Special case here.GüHa"), SuppressMessage("Maintainability", "S1541:Methods should not be too complex", Justification := "Better readability.GüHa")> _
        <System.Runtime.CompilerServices.Extension> _
