...
#Region "Methods"
        ...
        Public Function Compare(ByVal x As Single, ByVal y As Single, ByVal Optional equalityMultiplier As Single? = Nothing) As Integer
